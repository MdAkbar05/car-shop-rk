...
export const Main = () => {
  return (
    <>
      <section className="customContainer py-28 bg-black flex justify-between gap-12  items-center">
        <div className="space-y-3">
          <div className="text-xl font-medium text-slate-100">NEW IN STOCK</div>
          <div className="text-6xl font-bold">EXCLUSIVE SPORTS CAR</div>
          ...
          <button className="lightBtn text-lg">Se more</button>
        </div>
